...
class ExaExaaltGraphRL(gym.Env):
    def __init__(self,**kwargs):
        ...
        self.action_space = gym.spaces.Box(low=0, high=self.n_states-1, shape=(self.n_states,), dtype=np.intc)
    ...
    def step(self, action):
        ...
        while(True):
            ...
            try:
                ...
                with open("./outputs/dataOutput_2dModel_BayesRL_"+NAME, "a") as myfile:
                        myfile.write(
                        str(round(self.WCT,3))+' '+
                        str(len(self.traj))+' '+
